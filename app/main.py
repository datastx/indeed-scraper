...
navigation_radio_button  = st.sidebar.radio("Naviagtion",ALL_NAVIATION_OPTIONS)

if navigation_radio_button == MONEY_GUN:
...
elif navigation_radio_button== ZOOM_INFO:
    st.info("This page is not built yet")


elif navigation_radio_button == HUB_SPOT:
    st.info("This page is not built yet")

else:
    st.info('This is the abyss. How did you get here?')